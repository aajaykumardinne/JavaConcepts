...
public class MethodOverloadinng {
	...
	// We can overload main method : Yess

	// You cannot create a method inside a method.
	// duplicate methods : same method name with the same number of input parameters
	// are not allowed.

	// Method Overloading
	// 1.when the method name is same with different arguments or input parameters
	// within the same class.
	// 2.make sure that the input parameters data type is different when the count
